    ...
    >
      ...
      <header style={{ textAlign: 'center', marginBottom: '1.25rem' }}>
        ...
        <h1 style={{ fontSize: '2rem', margin: '.25rem 0 .5rem', fontWeight: 700 }}>
          Brigit — Grounded in care
        </h1>
        <p style={{ color: '#d1d5db', maxWidth: 840, margin: '0 auto', lineHeight: 1.7 }}>
          Brigit leads with compassion and clarity. Her work focuses on safe, dignified access to support — listening
          first, then guiding people through at their pace.
        </p>
      </header>
